        ...
        <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
                ...
                <tr>
                    ...
                    <th>AMC Required ON (After days)</th>
                    <th>Action</th>
                </tr>
                </thead>
                <tbody> 
                     @foreach ($amcRequirList as $amc)
                        <tr>
                            <td>{{$amc->user->emp_id}}</td>
                            <td>{{$amc->user->name}}</td>
                            <td>{{$amc->cat->category_name}}</td>
                            <td>{{$amc->pir_no}}</td>
                            <td>{{$amc->po_date}}</td>
                            <td>{{$amc->warranty_years}}</td>
                            <td>{{$amc->days_left_warranty}}</td>
                            <td>
                                <a href='{{url("amcrgenerate/$amc->id")}}' class="btn btn-success">AMC Generator</a>
                            </td>
                        </tr> 
                    @endforeach 
                </tbody>
