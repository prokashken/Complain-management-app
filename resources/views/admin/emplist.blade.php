        ...
        <div class="table-wrapper">
            <table id="datatable1" class="table display responsive nowrap">
                ...
                <tr>
                    ...
                    <th class="wd-15p">Employ_ID</th>
                    <th class="wd-15p">Department</th>
                    <th class="wd-15p">Designation</th>
                    <th class="wd-15p">Email</th>
                    <th class="wd-15p">Phone</th>
                    <th class="wd-15p">Internal No</th>
                    <th class="wd-15p">Building Location</th>
                    <th class="wd-15p">Floor No</th>
                ...
                <tbody> 
                     @foreach ($empList as $emp)
                        <tr>
                            <td>
                                <form action="{{ url("/delete-employee/$emp->id") }}" method="POST"
                                    onsubmit="return confirm('Do you really want to delete the task?');">
                                    @csrf
                            ...
                            <td>{{$emp->email}}</td>
                            <td>{{$emp->phone}}</td>
                            <td>{{$emp->internal_no}}</td>
                            <td>{{$emp->building_location}}</td>
                            <td>{{$emp->floor_no}}</td>
                            <td>{{$emp->room_no}}</td>
                            <td>
                                <a href='{{url("/item-lists/$emp->id")}}' class="btn btn-success">Items</a>
                            </td>
                        </tr> 
                    @endforeach 
                </tbody>
